...
**macOS ARM (M-series) users**: [☞ Download TimeTrackBar-1.2 for macOS (.dmg)](https://github.com/aynorway/ay-timetrackbar-java/releases/download/v1.2/TimeTrackBar-1.2.dmg)
